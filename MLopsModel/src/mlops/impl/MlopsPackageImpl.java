 ...
 * @generated
 */
public class MlopsPackageImpl extends EPackageImpl implements MlopsPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see mlops.MlopsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private MlopsPackageImpl() {
		super(eNS_URI, MlopsFactory.eINSTANCE);
	}
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 *
	 * <p>This method is used to initialize {@link MlopsPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static MlopsPackage init() {
		if (isInited) return (MlopsPackage)EPackage.Registry.INSTANCE.getEPackage(MlopsPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredMlopsPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		MlopsPackageImpl theMlopsPackage = registeredMlopsPackage instanceof MlopsPackageImpl ? (MlopsPackageImpl)registeredMlopsPackage : new MlopsPackageImpl();

		isInited = true;

		// Create package meta-data objects
		theMlopsPackage.createPackageContents();

		// Initialize created meta-data
		theMlopsPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theMlopsPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(MlopsPackage.eNS_URI, theMlopsPackage);
		return theMlopsPackage;
	}
	 ...
	 */
	@Override
	public EReference getTraining_Parameters() {
	 ...
	 */
	@Override
	public MlopsFactory getMlopsFactory() {
		return (MlopsFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEReference(pipelineEClass, PIPELINE__DATA_PROCESSING);
		...
		createEReference(trainingEClass, TRAINING__PARAMETERS);
	...
	public void initializePackageContents() {
		...
		initEReference(getPipeline_DataProcessing(), this.getDataProcessing(), null, "dataProcessing", null, 0, 1, Pipeline.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPipeline_Training(), this.getTraining(), null, "training", null, 0, 1, Pipeline.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPipeline_Deployment(), this.getDeployment(), null, "deployment", null, 0, 1, Pipeline.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(dataProcessingEClass, DataProcessing.class, "DataProcessing", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getDataProcessing_InputPath(), ecorePackage.getEString(), "inputPath", null, 0, 1, DataProcessing.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getDataProcessing_OutputPath(), ecorePackage.getEString(), "outputPath", null, 0, 1, DataProcessing.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(trainingEClass, Training.class, "Training", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getTraining_Algorithm(), ecorePackage.getEString(), "algorithm", null, 0, 1, Training.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTraining_Parameters(), this.getParameter(), null, "parameters", null, 0, -1, Training.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getDeployment_TargetPlatform(), ecorePackage.getEString(), "targetPlatform", null, 0, 1, Deployment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getDeployment_Scalability(), ecorePackage.getEInt(), "scalability", null, 0, 1, Deployment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
